...
(function() {
  ...
  const FIELD_PATTERNS = {
    ...
    address: ['address', 'street', 'address1', 'addr', 'streetaddress', 'homeaddress', 'home_address'],
    addressLine2: ['address2', 'apt', 'suite', 'unit', 'apartment'],
    city: ['city', 'town', 'municipality', 'city/town', 'citytown', 'city_town'],
    state: ['state', 'province', 'region'],
    zipCode: ['zip', 'postal', 'postcode', 'zipcode', 'postalcode', 'postcode/zipcode', 'postalcode/zipcode'],
